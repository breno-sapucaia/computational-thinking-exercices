...
public class Exercicio10 {
	...
	public double nulos;
	public double total;
	// como são exericcio simples eu vo usar tudo public ok?
	public void executar() {
		...
		System.out.printf("A porcentagem de votos do candidato A em relação ao total = %.2f \n", (candidatoAVotos/total)*100);
		System.out.printf("A porcentagem de votos do candidato B em relação ao total = %.2f \n", (candidatoBVotos/total)*100);
		System.out.printf("A porcentagem de votos do candidato C em relação ao total = %.2f \n", (candidatoCVotos/total)*100);
		System.out.printf("A porcentagem de votos Nulos em relação ao total = %.2f \n", (nulos/total)*100);
		System.out.printf("A porcentagem de votos Brancos em relação ao total = %.2f \n", (branco/total)*100);
	}
}
