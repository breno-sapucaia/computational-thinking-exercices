...
public class Exercicio20 {
	...
	public void executar() {
		...
		System.out.println("Selecione a opção de destion ex: 1 ");
		...
		case 3:
			...
			break;
		default:
			System.out.println("Não trabalhamos com Sul e Sudeste");
			break;
		}
		System.out.println("o preco da passagem ficará de R$:" +preco);
		}
