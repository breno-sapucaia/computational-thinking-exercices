...
public class Exercicio9 {
	...
	public void executar() {
		...
		if(getMeses()<12) {
			System.out.println("irá demorar "+ getMeses() + " meses para você se tornar um milionário");
		}else {
			System.out.printf("irá demorar %.0f anos para você se tornar um milionário" ,(getMeses()/12 ));
		}
		System.out.println();
	}
}
